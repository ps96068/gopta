...
def register_all_catalog_listeners():
    ...
    if _catalog_listeners_registered:
        print("Listener-ii SQLAlchemy pentru Catalog sunt deja inregistrați. Se sare re-inregistrarea.")
        return False
...
def disable_all_catalog_listeners():
    ...
    from .product_image_signals import receive_before_insert
    from .product_price_signals import *
    ...
    event.remove(ProductImage, "before_insert", receive_before_insert)
